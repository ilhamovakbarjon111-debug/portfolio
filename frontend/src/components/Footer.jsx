...
const socials = [
  ...
  { href: 'mailto:ilhamovakbarjon.111@gmail.com', icon: Mail, label: 'Email' },
  { href: 'https://github.com/akbarjon-ilhamov', icon: Github, label: 'GitHub' },
]
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 order-1 sm:order-2 flex-wrap justify-center sm:justify-end">
            <span className="text-xs text-[var(--text-muted)] uppercase tracking-wider w-full sm:w-auto text-center sm:text-right">
              {t.footer.follow}
            </span>
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    className="p-2.5 rounded-xl bg-[var(--surface-elevated)] border border-[var(--border)] text-[var(--text-muted)] hover:text-[var(--accent)] hover:border-[var(--accent)]/50 hover:scale-110 transition-all inline-flex items-center justify-center"
                    aria-label={s.label}
                    title={s.label}
                  >
